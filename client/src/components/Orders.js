            ...
            <tbody>
              {orders.map((order, index) => (
                <tr key={index} className="border-b text-gray-700">
                  <td className="py-3 px-4 whitespace-nowrap font-barlow text-[16px] leading-[26px] tracking-normal font-normal text-black"> {order._id ? order._id.slice(0, 8) + "..." : "N/A"}</td>
